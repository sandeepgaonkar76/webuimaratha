...
class DisableMyProfileComponents extends Component{
...
<div className="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom px-3">
   <h1 className="h2">Disable My Profile</h1>
 </div>
	 {/* 1 */}
	...
	<div className="row">
			<div className="col-md-12">
				<div className="ProfileText">
					...
					<h2 >Disable My Profile</h2>
					<Row style={{padding:"10px"}}>
					
					<Col className="col-">
					<div className="form-group">
					<label htmlFor="edit-name">Enter Your Password</label>
          <input type="text" id="aboutMe" name="aboutMe" className="form-text required" onChange={this.handleChange} style={{wdith:"100%",height:"40px"}} value={this.state.aboutMe} />
					...
					<Col className="col-">
					<div className="form-group">
					<label htmlFor="edit-name"><b>Agreement</b></label>
                    <div className="clearfix"></div>
                    <input type="checkbox" id="termsandconditions" name="termsandconditions"  style={{display:"inline-block",width:"auto"}} />
                              <span>&nbsp;I accept &nbsp; to disable my profile
                                Terms &amp; Conditions&nbsp;
                                and &nbsp;
                                Privacy Policy
                                </span>
					...
					<button id="btnLogin" type="submit">Disable My Profile</button>
					</div>
					</Col>
				</Row>
...
export default withRouter(DisableMyProfileComponents);