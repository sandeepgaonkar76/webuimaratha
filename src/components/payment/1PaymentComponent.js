...
class PaymentComponent extends Component{
  ...
  componentDidMount()
  {
    ...
    Axios.post("http://localhost:3000/hash",{key,txnid,amount,productinfo,firstname,email,salt})
    .then(res=>{
                          ...
                          <Col sm={6}>
                           <Form.Group controlId="admissionForm.lastname">
                            ...
                            <Form.Group controlId="admissionForm.email">
                              ...
                              <Form.Control type="Service Provider" placeholder="service_provider" name='service_provider' value={this.state.serviceProvider} defaultValue />
                            </Form.Group>

                            <Form.Group controlId="admissionForm.phoneno">
                              <Form.Label>HASH</Form.Label>
                              <Form.Control type="text" placeholder="hash"  name='hash'  value={this.state.hash} defaultValue />
                            </Form.Group>                            
