	...
	<section className="about-us-page">
		...
		<div className="row">
				<div className="col-md-12">
					...
					<p>Now a days marriage is growing as a trend due to the changing rules and regulations, parental choice in the search of Bride/Bridegroom is diminishing.</p><b><a href="/about">More..</a></b>
				</div>		
