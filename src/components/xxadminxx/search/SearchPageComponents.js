...
redirectToSearchResult = (e) => {
    ...
    render() {
		const { history } = this.props;
		const {userID,ageFrom,ageTo,gender,searchresult,heightFrom,heightTo,castev} = (this.props.location && this.props.location.state) || {};
        return (
        <div>
        <TopBarComponents/>
...
<section className="search text-center">
  ...
  <Tab eventKey="1a" title="Quick Search">
  <form onSubmit={this.handlequicksearch}>
  <div className="headinf-tab">
											<h2>Quick Search</h2>
											<p>Searches profiles and provide you suitable profiles quickly.</p>
									  </div>
										<div className="row">
  ...
  <Tab eventKey="2a" title="Basic Search1">
